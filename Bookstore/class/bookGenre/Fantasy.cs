...
namespace Bookstore.@class
{
    public class Fantasy : Book
    {
        ...
        private List<string> listOfPossibleMagicalCreatures = new List<string>
            { "Vampires", "Werewolves", "Witches", "Wizzards", "Dragons", "Alliens", "Zombies", "Mermaids", "Others" };
            ...
            set
            {
                if (value == null || value.Count == 0 || value.Contains(""))
                {
                    throw new ArgumentException(
                        "You must have at least one magical creature. Its name must not be empty");
                }
