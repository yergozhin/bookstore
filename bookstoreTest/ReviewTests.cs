...
namespace Bookstore.@class.Tests
{
    ...
    {
        private readonly Review review1 = new Review(5, "Amazing read!", new DateTime(2024, 10, 31));
        private readonly Review review2 = new Review(3, "It was ok.", new DateTime(2024, 11, 1));
