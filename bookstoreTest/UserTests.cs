    ...
    public class UserTests
    {
        ...
        public void CheckEmptyName_ShouldThrowException()
        {
            Assert.Throws<ArgumentException>(() =>
                new User("", "555-555-5555", "test@user.com", new DateTime(2000, 1, 1)));
        }
        ...
        {
            Assert.Throws<ArgumentException>(() =>
                new User("Stefan Salvatore", "555-555-5555", "stefansalvatore.com", new DateTime(1846, 11, 1)));
        }
        ...
        public void CheckDuplicateEmail_ShouldThrowException()
        {
            Assert.Throws<InvalidOperationException>(() =>
                new User("Klaus Mikaelson", "555-123-4567", "elena@gilbert.com", new DateTime(1000, 5, 5)));
        }
        ...
        {
            user1.UpdateUser(newName: "Elena Salvatore", newPhoneNumber: "555-555-5555",
                newEmail: "elena@salvatore.com");
